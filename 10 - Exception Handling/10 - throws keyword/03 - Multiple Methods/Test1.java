...
- Since the InterruptedException is a checked exception, the methods should either handle it using a try-catch block or 
  declare that they throw InterruptedException.
*/